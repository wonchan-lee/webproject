...
//       fetch('https://webproject-dldnjscks19246462.codeanyapp.com/write/').then(function(response){
...
module.exports = {
  HTML:function(nickname, article1, article2, logined){
    var loginhref='test';
    var ment='';
    if(logined === true){
      loginhref='<a class="btn btn-sm btn-outline-secondary" href="/login/logout">logout</a>'
      ment='님 환영합니다';
    }else{
      loginhref='<a class="btn btn-sm btn-outline-secondary" href="/login/">login</a>'
    }
...
<div class="container">
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <div class="col-4 text-center">
        <a class="blog-header-logo text-dark" href="#">Wonchan</a>
      </div>
      <div class="col-4 d-flex justify-content-end align-items-center">
       ...
       <!-- <a class="link-secondary" href="#" aria-label="Search">
        ...
        <a class="btn btn-sm btn-outline-secondary" href="/login/signin">Sign in</a>
      </div>
    </div>
  </header>
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between" style="padding-top: 8px;">
      <a class="btn btn-sm btn-outline-secondary" href="/read/list" style="height: 32px;">
      <!-- 책 아이콘 -->
      ...
      &nbsp; Read</a>
      <a class="btn btn-sm btn-outline-secondary" href="/write/">
      <!-- 펜 아이콘 -->
...
<main class="container">
  <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <div class="col-md-6 px-0">
      <h1 class="display-4 fst-italic">wonchan's blog post</h1>
      <p class="lead my-3">이원찬</p>
      <p class="lead mb-0"><a href="/read/list" class="text-white fw-bold">Continue reading...</a></p>
    </div>
  </div>
  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        <h2 class="blog-post-title">이원찬</h2>
        <p class="blog-post-meta">April 3th, 2000</p>
