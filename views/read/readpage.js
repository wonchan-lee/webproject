    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p>
          ...
          &nbsp; Write Article</a>
          &nbsp;
          <a href="/read/list" class="btn btn-secondary my-2" style="padding-top: 4px;">
          <!-- 리스트 아이콘 -->
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-list" viewBox="0 0 16 16" style="margin-bottom: 2.1px;">
  ...
  <div class="album py-5 bg-light">
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-sm-12 row-cols-md-12 g-12">
       ...
       <div class="col">
          <div class="card shadow-sm">
            <svg class="bd-placeholder-img card-img-top" width="100%" height="50" xmlns="http://www.w3.org/2000/svg" role="img"  preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#55595c"/><text x="17" y="50%" fill="#eceeef" dy=".3em">Title : ${title}</text></svg>
            <div class="card-body">
